...
export default function HospitalAlertDetailScreen() {
  ...
  const styles = useThemedStyles((c) => ({
    ...
    escalationTitle: { color: c.success, fontSize: 12, fontWeight: "700" },
    escalationSub: { color: c.textMuted, fontSize: 11 },
    // Clôture
    closedCard: {
      flexDirection: "row",
      alignItems: "center",
  ...
  const isEscalated = alert.origin === "CNTS_ESCALATION";
        ...
        >
            ...
            <View style={styles.heroTop}>
              ...
              <View style={styles.heroInfo}>
                <Text style={styles.hospitalName} numberOfLines={2}>
                  {alert.healthStructure?.name ?? "Notre Établissement"}
                </Text>
          ...
          {isEscalated && (
            <View style={styles.escalationBanner}>
              ...
              <View style={{ flex: 1, gap: 2 }}>
                <Text style={styles.escalationTitle}>Prise en charge CNTS</Text>
                <Text style={styles.escalationSub}>
                  La CNTS a escaladé cette alerte et gère les réserves.
                </Text>
              </View>
            </View>
          )}
          ...
          <View style={styles.progressCard}>
            ...
            <Text style={styles.progressSub}>
              {progressPct >= 100
                ? "Quota atteint ✓"
                : `${alert.quantityNeeded - alert.quantityConfirmed} donneur(s) manquant(s)`}
            </Text>
          </View>
            ...
            <View style={styles.closedCard}>
              ...
              <View style={{ flex: 1, gap: 3 }}>
                ...
                <Text style={styles.closedSub}>
                  {alert.quantityConfirmed} donneur(s) se sont présentés.
                </Text>
              </View>
            </View>
          )}
