...
import { getThemeStatusConfig } from "@/src/constants/donationDayConfig";

dayjs.locale("fr");

interface DonationDayCardProps {
  item: DonationDay;
  onPress: () => void;
}

export function DonationDayCard({ item, onPress }: DonationDayCardProps) {
  ...
  const styles = useThemedStyles((c) => ({
    // ... (Tous les styles de la carte originaux, intacts)
    card: {
